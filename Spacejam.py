...
class SpaceJam(ShowBase):
    ...
    def __init__(self):
        ...
        self.Planet3 = spaceJamClasses.Planet(self.loader, "./Assets/Planets/protoPlanet.x", self.render, 'Planet3', "./Assets/Planets/mars.jpg", Vec3(300,600,500), 150)
        self.Planet4 = spaceJamClasses.Planet(self.loader, "./Assets/Planets/protoPlanet.x", self.render, 'Planet4', "./Assets/Planets/mars.jpg", Vec3(300,6000,500), 150 )
